...
router.post('/google-login-token', (0, validateRequest_1.default)(auth_validation_1.AuthValidations.googleLoginTokenZodSchema), custom_auth_controller_1.CustomAuthController.googleLoginToken);
