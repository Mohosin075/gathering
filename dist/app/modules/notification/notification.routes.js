...
router.get('/', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.ORGANIZER, user_1.USER_ROLES.USER), (0, validateRequest_1.default)(notification_validation_1.NotificationValidations.filter), notification_controller_1.NotificationController.getAllNotifications);
...
router.post('/', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.ORGANIZER, user_1.USER_ROLES.USER), (0, validateRequest_1.default)(notification_validation_1.NotificationValidations.create), notification_controller_1.NotificationController.createNotification);
router.post('/event', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.ORGANIZER), notification_controller_1.NotificationController.createEventNotification);
...
router.delete('/:id', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.ORGANIZER, user_1.USER_ROLES.USER), notification_controller_1.NotificationController.deleteNotification);
