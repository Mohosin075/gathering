...
EmailTemplates.templates = {
    ...
    [notification_constant_1.NOTIFICATION_TEMPLATES.WELCOME]: {
        getTitle: (data) => `Welcome to EventHub, ${data.userName}!`,
        getSubject: (data) => `Welcome to EventHub!`,
        getBody: (data) => `
    ...
    // Ticket Confirmation
    [notification_constant_1.NOTIFICATION_TEMPLATES.TICKET_CONFIRMATION]: {
        getTitle: (data) => `Ticket Confirmed!`,
        getSubject: (data) => `Ticket Confirmation - ${data.eventTitle}`,
        getBody: (data) => `
    ...
    // Event Reminder
    [notification_constant_1.NOTIFICATION_TEMPLATES.EVENT_REMINDER]: {
        getTitle: (data) => `Event Reminder: ${data.eventTitle}`,
        getSubject: (data) => `Reminder: ${data.eventTitle} starts ${data.timeUntilEvent}`,
        getBody: (data) => `
    ...
    // Event Created
    [notification_constant_1.NOTIFICATION_TEMPLATES.EVENT_CREATED]: {
        getTitle: (data) => `New Event Created!`,
        getSubject: (data) => `Your Event "${data.eventTitle}" is Live`,
        getBody: (data) => `
    ...
    // Attendee Checked In
    [notification_constant_1.NOTIFICATION_TEMPLATES.ATTENDEE_CHECKED_IN]: {
        getTitle: (data) => `Checked In Successfully!`,
        getSubject: (data) => `Check-in Confirmation - ${data.eventTitle}`,
        getBody: (data) => `
