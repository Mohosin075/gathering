...
const createEventNotification = (0, catchAsync_1.default)(async (req, res) => {
    const { eventId, type, title, content, metadata } = req.body;
    await notification_service_1.NotificationServices.createNotificationForEvent(eventId, type, title, content, metadata);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
