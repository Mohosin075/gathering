...
router.get('/', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.ORGANIZER), event_controller_1.EventController.getAllEvents);
router.get('/my-events', (0, auth_1.default)(user_1.USER_ROLES.ORGANIZER), event_controller_1.EventController.getMyEvents);
router.get('/:id', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.ORGANIZER), event_controller_1.EventController.getSingleEvent);
